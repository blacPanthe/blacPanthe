...
<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=2563EB&center=true&vCenter=true&width=700&lines=I+help+companies+stop+guessing+and+start+predicting;Building+ML+models%2C+pipelines%2C+and+analytics+systems;Turning+messy+data+into+decisions+that+move+revenue" alt="Typing SVG" />
  </a>
</p>
...
**[Samsung Health Analytics](https://github.com/blacPanthe/Samsung-health-analytics)** — End-to-end pipeline on 6 years of personal health data: cleaning, feature engineering (108 features), K-Means clustering, automatic life-phase detection, and Random Forest models predicting weight trajectory (0.34kg MAE) with goal-achievement simulation.
...
<p align="center"><i>Open to Data Scientist · ML Engineer · Data Analyst · Business Analyst roles — hybrid or remote.<br/>📩 atharvabakde@gmail.com&nbsp;&nbsp;|&nbsp;&nbsp;🌐 <a href="https://blacpanthe.github.io/AtharvabakdePortfolio2.0/">blacpanthe.github.io/AtharvabakdePortfolio2.0</a></i></p>
